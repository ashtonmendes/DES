...
void decrypt3(char* key, char* tableFileName, char* fileName)
{
	...
	keySchedulerForDecrypt3(keyBytes[2], roundKeys[0], PC1, PC2, V);
	keySchedulerForEncrypt3(keyBytes[1], roundKeys[1], PC1, PC2, V);
	keySchedulerForDecrypt3(keyBytes[0], roundKeys[2], PC1, PC2, V);
